                ...
                <Box textAlign="center">
                    <img
                        ...
                        <Typography variant="h2" sx={{my: 2}}>
                            Você ainda não tem permissão para acessar a área!
                        </Typography>

                        <Typography color='text.secondary' sx={{mb: 4}}>
                            Se você solicitou para a administração a permissão para cessar a área, clique no botão abaixo e atualize a página!
                        </Typography>
